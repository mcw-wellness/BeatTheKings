            ...
            >
              <div className="text-center space-y-3">
                <div className="flex justify-center">
                  {feature.id === 'avatar' && (
                    <svg
                      className={`w-16 h-16 ${feature.locked ? 'text-gray-500' : 'text-gray-700'}`}
                      fill="currentColor"
                      viewBox="0 0 24 24"
                    >
                  ...
                  {feature.id === 'ranking' && (
                    <svg
                      className={`w-16 h-16 ${feature.locked ? 'text-gray-500' : 'text-yellow-500'}`}
                      fill="currentColor"
                      viewBox="0 0 24 24"
                    >
                  ...
                  {feature.id === 'map' && (
                    <svg
                      className={`w-16 h-16 ${feature.locked ? 'text-gray-500' : 'text-blue-500'}`}
                      fill="currentColor"
                      viewBox="0 0 24 24"
                    >
                ...
                <h3
                  className={`text-lg font-bold ${feature.locked ? 'text-gray-600' : 'text-gray-900'}`}
                >
                  {feature.name}
                </h3>
