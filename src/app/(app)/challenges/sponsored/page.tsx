...
export default function SponsoredChallengesPage(): JSX.Element {
  ...
  return (
    ...
    >
      ...
      <div className="px-3 py-2 space-y-3 relative z-10 flex flex-col h-full">
        {/* Header */}
        ...
        {/* Coming Soon Card */}
        <div className="bg-[#1e2a4a]/90 backdrop-blur rounded-xl p-4 border border-white/10 text-center">
        ...
        <button
          ...
          className="w-full bg-[#1e2a4a]/80 border border-white/10 text-white font-medium py-3 rounded-xl transition-colors hover:bg-[#1e2a4a] shrink-0"
        >
          ← Back to Challenges
        </button>
      </div>
